      ...
      <div className="flex-1 flex flex-col justify-center px-6 lg:px-16 xl:px-24 py-12 relative z-10">
        <div className="w-full max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {mode !== 'forgot-password' && (
              <div className={animationClass} style={staggerDelay(mode === 'signup' ? 7 : 6)}>
                <button
                  type="button"
                  onClick={async () => {
                    playClick();
                  ...
                  onMouseEnter={playHover}
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-3 py-4 bg-secondary/50 border border-border rounded-xl hover:bg-secondary hover:border-primary/30 transition-all duration-300 group disabled:opacity-70 disabled:cursor-not-allowed"
                >
